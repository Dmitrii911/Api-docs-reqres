...
<a id="jenkins"></a>
## <img src="media/logo/Jenkins.svg" width="25" height="25"/></a> Запуск тестов в [Jenkins](https://jenkins.autotests.cloud/job/DVO-Reqres-Test-API/)

<p align="center">

> Для запуска необходимо нажать "Build Now".

<a href="https://jenkins.autotests.cloud/job/DVO-Reqres-Test-API/"><img src="media/screenshots/JenkinsSborka.png" alt="Jenkins"/></a>
...
<a href="https://jenkins.autotests.cloud/job/DVO-Reqres-Test-API/"><img src="media/screenshots/JenkinsIntegrations.png" alt="Jenkins"/></a>
</p>
